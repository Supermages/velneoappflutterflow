...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Center(
                  child: Image.asset(
                    'assets/images/ICONO_GERP_(1).png',
                    width: 290.0,
                    fit: BoxFit.fitWidth,
                  ),
                ),
      ...
      routes: [
        ...
        FFRoute(
          name: 'Firma',
          path: '/firma',
          builder: (context, params) => FirmaWidget(),
        ),
        FFRoute(
          name: 'Entrada',
          path: '/entrada',
        ...
        FFRoute(
          name: 'Partes',
          path: '/partes',
          builder: (context, params) => PartesWidget(
            signed: params.getParam('signed', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'ParteDetalle',
          path: '/parteDetalle',
          builder: (context, params) => ParteDetalleWidget(),
        ),
        FFRoute(
          name: 'Configuracion',
          path: '/configuracion',
