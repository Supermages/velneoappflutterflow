...
class ImagenGaleriaLogoBlanco extends StatefulWidget {
  const ImagenGaleriaLogoBlanco({
    Key? key,
    this.width,
    this.height,
  }) : super(key: key);
  ...
  final double? height;
  @override
  State<ImagenGaleriaLogoBlanco> createState() =>
      _ImagenGaleriaLogoBlancoState();
}
