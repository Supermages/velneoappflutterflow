...
class ImagenGaleria4 extends StatefulWidget {
  const ImagenGaleria4({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  State<ImagenGaleria4> createState() => _ImagenGaleria4State();
}

class _ImagenGaleria4State extends State<ImagenGaleria4> {
