...
class ImagenGaleria2 extends StatefulWidget {
  const ImagenGaleria2({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  State<ImagenGaleria2> createState() => _ImagenGaleria2State();
}

class _ImagenGaleria2State extends State<ImagenGaleria2> {
